...
### 🍽️ AI-Based Recipe Generator
- Built using Python Flask, HTML, CSS, and JavaScript
- Generates recipes using AI
- Creates recipe images using Stable Diffusion

### 🏦 Banking Management System
- Developed using Java, Spring Boot, MySQL, Thymeleaf
- Supports account creation, deposits, withdrawals, and transactions
